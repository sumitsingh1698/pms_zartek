...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<Myprofile>(
          stream: Apis().profile().asStream(),
                                ...
                                IconButton(
                                    ...
                                    onPressed: () {
                                      pushNewScreen(
                                        ...
                                        screen: Website(
                                          url:
                                              "https://zartek.in/hire-dedicated-developer ",
                                          titleName: "Dedicated Resources",
                                        ),
                                        withNavBar: false,
                                      );
                                    }),
